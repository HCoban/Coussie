...
Restaurant.create(name: "Wok", city: "San Francisco", lat: 37.13, lng: 37.123, category_id: 1, owner_id: 1)
Restaurant.create(name: "Bahnhof", city: "San Francisco", lat: 37.11, lng: 37.132, category_id: 2, owner_id: 2)
Restaurant.create(name: "Burger World", city: "San Francisco", lat: 37.01, lng: 37.1112, category_id: 3, owner_id: 5)
